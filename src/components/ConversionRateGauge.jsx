...
const ConversionRateGauge = ({ percentage, onClick }) => {
  return (
    <div className="flex flex-col sm:col-span-full md:col-span-3 xl:col-span-3 bg-white dark:bg-gray-800 shadow-xs rounded-xl p-5 cursor-pointer" onClick={onClick}>
